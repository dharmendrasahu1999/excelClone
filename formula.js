for(let i=0;i<rows;i++)
{
    for(let j=0;j<cols;j++)
    {
        ...
        cell.addEventListener("blur",(e)=>{
            ...
            //If data modifies removes P-c relation ,formula empty,update children with new hardcoded value
...
formulaBar.addEventListener("keydown",async (e)=>{
    ...
    if(e.key==="Enter" && inputFormula)
    {
        ...
        if(cycleResponse)
        {
            ...
            while(response===true){
                //keep on tracling color untill user is satisfied
                await isGraphCyclicTracePath(graphComponentMatrix,cycleResponse)//I want to complete full iteration of color traxcking
